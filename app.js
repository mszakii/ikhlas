...
app.get("/courses/:type", (req, res) => {
  ...
  if (type == "quran") {
    ...
    courses = [
      ...
      {
        img: "islamic/Islamic_history.jpg",
      ...
      {
        img: "islamic/stories_course.jpg",
      ...
      {
        img: "islamic/tafseer_course.jpg",
      ...
      {
        img: "islamic/tarbyah_course.jpg",
